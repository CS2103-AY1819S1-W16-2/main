...
public class AddressBookParserTest {
    ...
    /**
     * @Test public void parseCommand_addVolunteer() throws Exception {
    ...
    /**
     * @Test public void parseCommand_deleteVolunteer() throws Exception {
    ...
    /**
     * @Test public void parseCommand_editVolunteer() throws Exception {
     * Volunteer volunteer = new VolunteerBuilder().build();
    ...
    /**
     * @Test public void parseCommand_listVolunteer() throws Exception {
    ...
    /**
     * @Test public void parseCommand_selectVolunteer() throws Exception {
